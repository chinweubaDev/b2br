    ...
    <ul class="sidebar-menu">
        ...
        <li class="sidebar-menu-item">
            ...
            <ul class="sidebar-submenu" :class="{ 'open': visaOpen }" x-cloak>
                <li><a href="<?php echo e(route('visas.index')); ?>" class="sidebar-submenu-link">All Visas</a></li>
                <li><a href="<?php echo e(route('visas.create')); ?>" class="sidebar-submenu-link">Create Visa</a></li>
            </ul>
        </li>
        ...
        <li class="sidebar-menu-item">
            ...
            <ul class="sidebar-submenu" :class="{ 'open': tourOpen }" x-cloak>
                <li><a href="<?php echo e(route('tours.index')); ?>" class="sidebar-submenu-link">All Tours</a></li>
                <li><a href="<?php echo e(route('tours.create')); ?>" class="sidebar-submenu-link">Create Tour</a></li>
            </ul>
        </li>
        ...
        <li class="sidebar-menu-item">
            ...
            <ul class="sidebar-submenu" :class="{ 'open': hotelOpen }" x-cloak>
                <li><a href="<?php echo e(route('hotels.index')); ?>" class="sidebar-submenu-link">All Hotels</a></li>
                <li><a href="<?php echo e(route('hotels.create')); ?>" class="sidebar-submenu-link">Create Hotel</a></li>
            </ul>
        </li>
        ...
        <li class="sidebar-menu-item">
            ...
            <ul class="sidebar-submenu" :class="{ 'open': cruiseOpen }" x-cloak>
                <li><a href="<?php echo e(route('cruises.index')); ?>" class="sidebar-submenu-link">All Cruises</a></li>
                <li><a href="<?php echo e(route('cruises.create')); ?>" class="sidebar-submenu-link">Create Cruise</a></li>
            </ul>
        </li>
        ...
        <li class="sidebar-menu-item">
            ...
            <ul class="sidebar-submenu" :class="{ 'open': docOpen }" x-cloak>
                <li><a href="<?php echo e(route('documentation.index')); ?>" class="sidebar-submenu-link">All Docs</a></li>
                <li><a href="<?php echo e(route('documentation.create')); ?>" class="sidebar-submenu-link">Create Doc</a></li>
            </ul>
        </li>
...
</div> <?php /**PATH C:\Users\creat\Downloads\b2b\resources\views/admin/components/sidebar.blade.php ENDPATH**/ ?>