                        ...
                        <tr>
                            ...
                            <td>
                                <div class="service-cell">
                                    <span class="service-type">{{ ucfirst($payment->service_type) }}</span>
                                    <span class="service-name">{{ $payment->service_name }}</span>
                                </div>
                            </td>
                            ...
                            <td>
                                <span class="status-badge {{ strtolower($payment->payment_status) }}">
                                    {{ ucfirst($payment->payment_status) }}
                                </span>
                            </td>
                            <td style="text-align: right;">
                                <a href="{{ route('payment.details', $payment) }}" class="view-details-btn">
