...
@section('title', 'Admin Dashboard - Royeli Tours & Travel')
    ...
    <div class="flex items-center justify-between flex-wrap gap-4">
        ...
        <div class="flex items-center gap-3">
            <div class="text-right">
                ...
                <p class="text-lg font-semibold text-gray-200">{{ now()->format('F j, Y') }}</p>
            </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="stat-card animate-slide-in" style="animation-delay: 0.1s">
        ...
        <div class="stat-card-body">
            ...
            <p class="stat-card-value">{{ $userCount ?? '1,234' }}</p>
        </div>
    ...
    <div class="stat-card animate-slide-in" style="animation-delay: 0.2s">
        ...
        <div class="stat-card-body">
            ...
            <p class="stat-card-value">₦{{ number_format($totalRevenue ?? 5420000, 0) }}</p>
        </div>
        <div class="stat-card-footer">
            <span class="text-xs text-gray-400">This month</span>
            <a href="{{ route('admin.payments') }}" class="stat-card-link">
                View all <i class="fas fa-arrow-right text-xs"></i>
            </a>
        </div>
    </div>
    ...
    <div class="stat-card animate-slide-in" style="animation-delay: 0.3s">
        ...
        <div class="stat-card-body">
            ...
            <p class="stat-card-value">{{ $bookingCount ?? '89' }}</p>
        </div>
        <div class="stat-card-footer">
            <span class="text-xs text-gray-400">Pending: {{ $pendingBookings ?? '12' }}</span>
            <a href="{{ route('admin.bookings.index') }}" class="stat-card-link">
                View all <i class="fas fa-arrow-right text-xs"></i>
            </a>
        </div>
    </div>
    ...
    <div class="stat-card animate-slide-in" style="animation-delay: 0.4s">
        ...
        <div class="stat-card-body">
            ...
            <p class="stat-card-value">{{ $pendingApprovals ?? '7' }}</p>
        </div>
        <div class="stat-card-footer">
            <span class="text-xs text-gray-400">Requires action</span>
            <a href="{{ route('admin.partners.pending') }}" class="stat-card-link">
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="stat-card animate-fade-in">
        ...
        <div class="stat-card-body">
            ...
            <p class="stat-card-value">{{ $visaCount ?? '15' }}</p>
        </div>
        <div class="stat-card-footer">
            <a href="{{ route('visas.index') }}" class="stat-card-link">
                View all <i class="fas fa-arrow-right text-xs"></i>
            </a>
        </div>
    </div>
    ...
    <div class="stat-card animate-fade-in">
        ...
        <div class="stat-card-body">
            ...
            <p class="stat-card-value">{{ $tourCount ?? '8' }}</p>
        </div>
        <div class="stat-card-footer">
            <a href="{{ route('tours.index') }}" class="stat-card-link">
                View all <i class="fas fa-arrow-right text-xs"></i>
            </a>
        </div>
    </div>
    ...
    <div class="stat-card animate-fade-in">
        ...
        <div class="stat-card-body">
            ...
            <p class="stat-card-value">{{ $hotelCount ?? '25' }}</p>
        </div>
        <div class="stat-card-footer">
            <a href="{{ route('hotels.index') }}" class="stat-card-link">
                View all <i class="fas fa-arrow-right text-xs"></i>
            </a>
        </div>
    </div>
    ...
    <div class="stat-card animate-fade-in">
        ...
        <div class="stat-card-body">
            ...
            <p class="stat-card-value">{{ $cruiseCount ?? '3' }}</p>
        </div>
        <div class="stat-card-footer">
            <a href="{{ route('cruises.index') }}" class="stat-card-link">
                View all <i class="fas fa-arrow-right text-xs"></i>
            </a>
        </div>
    </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    ...
    <div class="glass-card p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('admin.logs') }}" class="text-sm text-purple-400 hover:text-purple-300">View all →</a>
        </div>
        <div class="space-y-4">
    ...
    <div class="glass-card p-6">
        ...
        <div class="grid grid-cols-2 gap-4">
            <a href="{{ route('visas.create') }}" class="p-4 rounded-xl bg-gradient-to-br from-purple-500/10 to-purple-500/5 border border-purple-500/20 hover:border-purple-500/40 transition group">
            ...
            <a href="{{ route('tours.create') }}" class="p-4 rounded-xl bg-gradient-to-br from-green-500/10 to-green-500/5 border border-green-500/20 hover:border-green-500/40 transition group">
            ...
            <a href="{{ route('hotels.create') }}" class="p-4 rounded-xl bg-gradient-to-br from-pink-500/10 to-pink-500/5 border border-pink-500/20 hover:border-pink-500/40 transition group">
            ...
            <a href="{{ route('cruises.create') }}" class="p-4 rounded-xl bg-gradient-to-br from-cyan-500/10 to-cyan-500/5 border border-cyan-500/20 hover:border-cyan-500/40 transition group">
            ...
            <a href="{{ route('admin.users.index') }}" class="p-4 rounded-xl bg-gradient-to-br from-blue-500/10 to-blue-500/5 border border-blue-500/20 hover:border-blue-500/40 transition group">
            ...
            <a href="{{ route('admin.payments') }}" class="p-4 rounded-xl bg-gradient-to-br from-yellow-500/10 to-yellow-500/5 border border-yellow-500/20 hover:border-yellow-500/40 transition group">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="glass-card p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('tours.index') }}" class="text-sm text-purple-400 hover:text-purple-300">View all →</a>
        </div>
        <div class="space-y-4">
    ...
    <div class="glass-card p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('visas.index') }}" class="text-sm text-purple-400 hover:text-purple-300">View all →</a>
        </div>
        <div class="space-y-4">
            <div class="p-4 rounded-lg bg-white bg-opacity-5 hover:bg-opacity-10 transition">
                <div class="flex items-center justify-between mb-2">
