...
@section('title', $visa->country->name . ' ' . ucfirst($visa->visa_type) . ' Visa Requirements - Royeli Tours & Travel')
    ...
    <div class="max-w-4xl mx-auto">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('visas.show', $visa) }}" class="ml-1 text-gray-700 hover:text-blue-600 md:ml-2">{{ $visa->country->name }} {{ ucfirst($visa->visa_type) }} Visa</a>
                    </div>
                </li>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">{{ $visa->country->name }} {{ ucfirst($visa->visa_type) }} Visa Requirements</h1>
                    <p class="text-gray-600 mt-2">Complete list of documents and requirements needed for your visa application</p>
                </div>
                <div class="flex items-center space-x-3">
                    <a href="{{ route('visas.show', $visa) }}" class="btn-secondary">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                        </svg>
                        Back to Details
                    </a>
                    <a href="{{ route('admin.bookings.create') }}?type=visa&service={{ $visa->country->name }} {{ $visa->visa_type }} visa" class="btn-primary">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <p class="text-gray-700">{{ $visa->processing_time }}</p>
                        </div>
                        <div class="bg-gray-50 rounded-lg p-4">
                            <h3 class="font-medium text-gray-900 mb-2">Service Fee</h3>
                            <p class="text-gray-700">B2B Rate: {{ $visa->formatted_b2b_rate }}</p>
                        </div>
                    </div>
                </div>
