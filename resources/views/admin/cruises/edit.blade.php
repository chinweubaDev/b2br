...
@section('title', 'Edit Cruise Package - Admin Dashboard')
@section('page-title', 'Edit Cruise Package')
...
<div class="glass-card p-6 mb-8">
    <div class="flex items-center justify-between flex-wrap gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-200">Edit Cruise Package</h1>
            <p class="text-gray-400 mt-1">Update {{ $cruise->name }}</p>
        </div>
...
<div class="glass-card p-6">
    <form method="POST" action="{{ route('admin.cruises.update', $cruise) }}" enctype="multipart/form-data" class="space-y-8">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="ship_name" 
                        name="ship_name" 
                        value="{{ old('ship_name', $cruise->ship_name) }}" 
                        required 
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input 
                        ...
                        id="departure_date" 
                        name="departure_date" 
                        value="{{ old('departure_date', $cruise->departure_date) }}" 
                        required 
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="return_date" 
                        name="return_date" 
                        value="{{ old('return_date', $cruise->return_date) }}" 
                        required 
                ...
                <div>
                    ...
                    <input 
                        ...
                        value="{{ old('duration_nights', $cruise->duration_nights) }}" 
                        min="1" 
                        required 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input 
                        ...
                        id="standard_rate" 
                        name="standard_rate" 
                        value="{{ old('standard_rate', $cruise->standard_rate) }}" 
                        step="0.01" 
                        min="0" 
                        required 
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="b2b_rate" 
                        name="b2b_rate" 
                        value="{{ old('b2b_rate', $cruise->b2b_rate) }}" 
                        step="0.01" 
                        min="0" 
                        required 
        ...
        <div>
            ...
            <div>
                ...
                >{{ old('description', $cruise->description) }}</textarea>
                @error('description')
                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    >{{ old('ports_of_call', $cruise->ports_of_call) }}</textarea>
                    @error('ports_of_call')
                        <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    >{{ old('inclusions', $cruise->inclusions) }}</textarea>
                    @error('inclusions')
                        <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div>
            ...
            <div>
                ...
                >{{ old('exclusions', $cruise->exclusions) }}</textarea>
                @error('exclusions')
                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                @if($cruise->image)
                    <div class="mb-3">
                        ...
                        <img src="{{ asset('storage/' . $cruise->image) }}" alt="{{ $cruise->name }}" class="w-32 h-32 object-cover rounded-lg border border-gray-700">
                        <p class="text-xs text-gray-400 mt-1">Current cruise image</p>
                    </div>
                @endif
                
                <label for="image" class="block text-sm font-medium text-gray-300 mb-2">
                    {{ $cruise->image ? 'New Cruise Image' : 'Cruise Image' }}
                </label>
                <input 
                    type="file" 
                    id="image" 
        ...
        <div>
            ...
            <div class="flex items-center">
                <input 
                    ...
                    name="is_active" 
                    value="1" 
                    {{ old('is_active', $cruise->is_active) ? 'checked' : '' }} 
        ...
        <div class="flex items-center gap-4 pt-4 border-t border-gray-700">
            ...
            >
                <i class="fas fa-save mr-2"></i>Update Cruise Package
            </button>
            <a 
