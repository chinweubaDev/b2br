<?php $__env->startSection('title', 'Cruise Packages - Royeli Tours & Travel'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                ...
                <input type="text" id="search" placeholder="Search cruise packages..." class="w-full border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" value="<?php echo e(request('search')); ?>">
            </div>
            <div>
                ...
                <select id="destination" class="w-full border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <?php $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($route); ?>" <?php echo e(request('destination') == $route ? 'selected' : ''); ?>>
                            <?php echo e($route); ?>
            ...
            <div>
                ...
                <select id="cruise_line" class="w-full border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <?php $__currentLoopData = $cruiseLines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cruiseLine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($cruiseLine); ?>" <?php echo e(request('cruise_line') == $cruiseLine ? 'selected' : ''); ?>>
                            <?php echo e($cruiseLine); ?>
            ...
            <div>
                ...
                <select id="duration" class="w-full border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <option value="1-3" <?php echo e(request('duration') == '1-3' ? 'selected' : ''); ?>>1-3 Days</option>
                    <option value="4-7" <?php echo e(request('duration') == '4-7' ? 'selected' : ''); ?>>4-7 Days</option>
                    <option value="8-14" <?php echo e(request('duration') == '8-14' ? 'selected' : ''); ?>>8-14 Days</option>
                    <option value="15+" <?php echo e(request('duration') == '15+' ? 'selected' : ''); ?>>15+ Days</option>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php $__empty_1 = true; $__currentLoopData = $cruises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cruise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <?php if($cruise->image): ?>
                    <div class="h-48 bg-gray-200 overflow-hidden">
                        <img src="<?php echo e(asset('storage/' . $cruise->image)); ?>" alt="<?php echo e($cruise->name); ?>" class="w-full h-full object-cover">
                    </div>
                <?php else: ?>
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <h3 class="text-lg font-semibold text-gray-900"><?php echo e($cruise->name); ?></h3>
                                <p class="text-sm text-gray-500"><?php echo e($cruise->cruise_line); ?></p>
                            </div>
                        </div>
                        <?php if($cruise->is_featured): ?>
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-medium"><?php echo e($cruise->destination); ?></span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-500">Duration:</span>
                            <span class="font-medium"><?php echo e($cruise->duration_days); ?> Days</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-500">Standard Rate:</span>
                            <span class="font-medium">₦<?php echo e(number_format($cruise->standard_rate)); ?></span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-500">B2B Rate:</span>
                            <span class="font-medium text-green-600">₦<?php echo e(number_format($cruise->b2b_rate)); ?></span>
                        </div>
                    </div>
                    
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        <div class="flex space-x-2">
                            <a href="<?php echo e(route('cruises.show', $cruise)); ?>" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white text-center py-2 px-3 rounded-lg text-sm font-medium">
                                View Details
                            </a>
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(route('payment.options', ['cruise', $cruise->id])); ?>" class="flex-1 bg-green-600 hover:bg-green-700 text-white text-center py-2 px-3 rounded-lg text-sm font-medium">
                                    <i class="fas fa-credit-card mr-1"></i>
                                    Book Now
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="flex-1 bg-green-600 hover:bg-green-700 text-white text-center py-2 px-3 rounded-lg text-sm font-medium" title="Please log in to book this cruise">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function applyFilters() {
            ...
            window.location.href = queryString ? `<?php echo e(route('cruises.index')); ?>?${queryString}` : '<?php echo e(route('cruises.index')); ?>';
        }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/simeonuba/b2br/resources/views/cruises/index.blade.php ENDPATH**/ ?>