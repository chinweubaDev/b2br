...
<div class="glass-card p-6">
    <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" class="space-y-8">
        <?php echo csrf_field(); ?>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input 
                        ...
                        value="<?php echo e(config('paystack.publicKey') ?? 'pk_test_xxxxx'); ?>"
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input 
                        type="text" 
                        name="mail_host" 
                        value="<?php echo e(config('mail.mailers.smtp.host') ?? 'smtp.mailtrap.io'); ?>"
                        class="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition"
                    >
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input 
                            type="text" 
                            name="mail_port" 
                            value="<?php echo e(config('mail.mailers.smtp.port') ?? '2525'); ?>"
                            class="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition"
                        >
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <input 
                        ...
                        value="<?php echo e(config('mail.from.address') ?? 'noreply@b2br.com'); ?>"
                        class="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition"
                    >
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/simeonuba/b2br/resources/views/admin/settings.blade.php ENDPATH**/ ?>