...
@section('title', 'Create Hotel - Admin Dashboard')
...
<div class="glass-card p-6 mb-8">
    <div class="flex items-center justify-between flex-wrap gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-200">Add New Hotel</h1>
            <p class="text-gray-400 mt-1">Fill in the details below to add a new hotel to the system</p>
        </div>
...
<div class="glass-card p-6">
    <form method="POST" action="{{ route('admin.hotels.store') }}" enctype="multipart/form-data" class="space-y-8">
        @csrf
