            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-gray-500 md:ml-2"><?php echo e($visa->country->name); ?> <?php echo e(ucfirst($visa->visa_type)); ?> Visa</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900"><?php echo e($visa->country->name); ?> <?php echo e(ucfirst($visa->visa_type)); ?> Visa</h1>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u363422527/domains/royelimytravel.com/public_html/b2b/resources/views/admin/visas/visas/show.blade.php ENDPATH**/ ?>