...
<body>
    <div class="invoice-container">
        ...
        <!-- Travel Information -->
        @if($booking->travel_date || $booking->return_date || $booking->passengers)
        <div class="service-details">
            ...
            <table class="service-table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $booking->travel_date->format('F d, Y') }}</td>
                    </tr>
                    @endif
                    @if($booking->return_date)
                    <tr>
                        <td><strong>Return Date:</strong></td>
                        <td>{{ $booking->return_date->format('F d, Y') }}</td>
                    </tr>
                    @endif
        ...
        <div class="service-details">
            ...
            <p style="color: #6c757d; margin: 10px 0;">{{ $booking->special_requirements }}</p>
        </div>
        @endif
        ...
        <div class="amount-section">
            <div class="total-amount">
                Total Amount: {{ $booking->currency }} {{ number_format($booking->amount, 2) }}
            </div>
        </div>
