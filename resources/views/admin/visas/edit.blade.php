...
@section('title', 'Edit Visa Service - Admin Dashboard')
@section('page-title', 'Edit Visa Service')
...
<div class="glass-card p-6 mb-8">
    <div class="flex items-center justify-between flex-wrap gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-200">Edit Visa Service</h1>
            <p class="text-gray-400 mt-1">Update visa service information</p>
        </div>
...
<div class="glass-card p-6">
    <form method="POST" action="{{ route('admin.visas.update', $visa) }}" enctype="multipart/form-data" class="space-y-8">
        @csrf
        @method('PUT')
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input 
                        ...
                        id="service_name" 
                        name="service_name" 
                        value="{{ old('service_name', $visa->service_name) }}" 
                        required 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        >
                            ...
                            @foreach(\App\Models\Country::all() as $country)
                                <option value="{{ $country->id }}" {{ old('country_id', $visa->country_id) == $country->id ? 'selected' : '' }}>
                                    {{ $country->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="tourist" {{ old('visa_type', $visa->visa_type) == 'tourist' ? 'selected' : '' }}>Tourist Visa</option>
                            <option value="business" {{ old('visa_type', $visa->visa_type) == 'business' ? 'selected' : '' }}>Business Visa</option>
                            <option value="student" {{ old('visa_type', $visa->visa_type) == 'student' ? 'selected' : '' }}>Student Visa</option>
                            <option value="work" {{ old('visa_type', $visa->visa_type) == 'work' ? 'selected' : '' }}>Work Visa</option>
                            <option value="transit" {{ old('visa_type', $visa->visa_type) == 'transit' ? 'selected' : '' }}>Transit Visa</option>
                            <option value="diplomatic" {{ old('visa_type', $visa->visa_type) == 'diplomatic' ? 'selected' : '' }}>Diplomatic Visa</option>
                        </select>
                        @error('visa_type')
                            <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                        @enderror
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input 
                        ...
                        id="standard_rate" 
                        name="standard_rate" 
                        value="{{ old('standard_rate', $visa->standard_rate) }}" 
                        step="0.01" 
                        min="0" 
                        required 
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="b2b_rate" 
                        name="b2b_rate" 
                        value="{{ old('b2b_rate', $visa->b2b_rate) }}" 
                        step="0.01" 
                        min="0" 
                        required 
                    ...
                    @error('b2b_rate')
                        <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-xs text-gray-400 mt-1">Business partner rate</p>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input 
                        ...
                        value="{{ old('processing_time', $visa->processing_time) }}" 
                        required 
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="cost_includes" 
                        name="cost_includes" 
                        value="{{ old('cost_includes', $visa->cost_includes) }}" 
        ...
        <div>
            ...
            <div>
                ...
                >{{ old('requirements', $visa->requirements) }}</textarea>
        ...
        <div>
            ...
            <div>
                ...
                >{{ old('additional_notes', $visa->additional_notes) }}</textarea>
        ...
        <div>
            ...
            <div class="flex items-center">
                <input 
                    ...
                    name="is_active" 
                    value="1" 
                    {{ old('is_active', $visa->is_active) ? 'checked' : '' }} 
        ...
        <div class="flex items-center gap-4 pt-4 border-t border-gray-700">
            ...
            >
                <i class="fas fa-save mr-2"></i>Update Visa Service
            </button>
            <a 
