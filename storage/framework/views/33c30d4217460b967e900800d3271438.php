    ...
    <ul class="sidebar-menu">
        ...
        <li class="sidebar-menu-item">
            <a href="<?php echo e(route('admin.payments')); ?>" 
               class="sidebar-menu-link <?php echo e(request()->routeIs('admin.payments') ? 'active' : ''); ?>">
        ...
        <!-- Wallet -->
        <li class="sidebar-menu-item">
            <a href="<?php echo e(route('admin.wallet-transactions')); ?>" 
               class="sidebar-menu-link <?php echo e(request()->routeIs('admin.wallet-transactions') ? 'active' : ''); ?>">
        ...
        <li class="sidebar-menu-item">
            ...
            <ul class="sidebar-submenu" :class="{ 'open': visaOpen }" x-cloak>
                <li><a href="<?php echo e(route('admin.visas.index')); ?>" class="sidebar-submenu-link">All Visas</a></li>
                <li><a href="<?php echo e(route('admin.visas.create')); ?>" class="sidebar-submenu-link">Create Visa</a></li>
            </ul>
        </li>
        ...
        <li class="sidebar-menu-item">
            ...
            <ul class="sidebar-submenu" :class="{ 'open': tourOpen }" x-cloak>
                <li><a href="<?php echo e(route('admin.tours.index')); ?>" class="sidebar-submenu-link">All Tours</a></li>
                <li><a href="<?php echo e(route('admin.tours.create')); ?>" class="sidebar-submenu-link">Create Tour</a></li>
            </ul>
        </li>
        ...
        <li class="sidebar-menu-item">
            ...
            <ul class="sidebar-submenu" :class="{ 'open': hotelOpen }" x-cloak>
                <li><a href="<?php echo e(route('admin.hotels.index')); ?>" class="sidebar-submenu-link">All Hotels</a></li>
                <li><a href="<?php echo e(route('admin.hotels.create')); ?>" class="sidebar-submenu-link">Create Hotel</a></li>
            </ul>
        </li>
        ...
        <li class="sidebar-menu-item">
            ...
            <ul class="sidebar-submenu" :class="{ 'open': cruiseOpen }" x-cloak>
                <li><a href="<?php echo e(route('admin.cruises.index')); ?>" class="sidebar-submenu-link">All Cruises</a></li>
                <li><a href="<?php echo e(route('admin.cruises.create')); ?>" class="sidebar-submenu-link">Create Cruise</a></li>
            </ul>
        </li>
        ...
        <li class="sidebar-menu-item">
            ...
            <ul class="sidebar-submenu" :class="{ 'open': bookingOpen }" x-cloak>
                <li><a href="<?php echo e(route('admin.bookings.index')); ?>" class="sidebar-submenu-link">All Bookings</a></li>
                <li><a href="<?php echo e(route('admin.bookings.pending')); ?>" class="sidebar-submenu-link">Pending</a></li>
                <li><a href="<?php echo e(route('admin.bookings.confirmed')); ?>" class="sidebar-submenu-link">Confirmed</a></li>
            </ul>
        </li>
        ...
        <li class="sidebar-menu-item">
            ...
            <ul class="sidebar-submenu" :class="{ 'open': partnerOpen }" x-cloak>
                <li><a href="<?php echo e(route('admin.partners.index')); ?>" class="sidebar-submenu-link">All Partners</a></li>
                <li><a href="<?php echo e(route('admin.partners.pending')); ?>" class="sidebar-submenu-link">Pending Approval</a></li>
            </ul>
        </li>
        ...
        <li class="sidebar-menu-item">
            ...
            <ul class="sidebar-submenu" :class="{ 'open': docOpen }" x-cloak>
                <li><a href="<?php echo e(route('admin.documentation.index')); ?>" class="sidebar-submenu-link">All Docs</a></li>
                <li><a href="<?php echo e(route('admin.documentation.create')); ?>" class="sidebar-submenu-link">Create Doc</a></li>
            </ul>
        </li>
        ...
        <li class="sidebar-menu-item">
            <a href="<?php echo e(route('admin.settings')); ?>" 
               class="sidebar-menu-link <?php echo e(request()->routeIs('admin.settings') ? 'active' : ''); ?>">
        ...
        <li class="sidebar-menu-item">
            <a href="<?php echo e(route('admin.logs')); ?>" 
               class="sidebar-menu-link <?php echo e(request()->routeIs('admin.logs') ? 'active' : ''); ?>">
        ...
        <li class="sidebar-menu-item">
            <a href="<?php echo e(route('admin.backups')); ?>" 
               class="sidebar-menu-link <?php echo e(request()->routeIs('admin.backups') ? 'active' : ''); ?>">
...
</div> <?php /**PATH /Users/simeonuba/b2br/resources/views/admin/components/sidebar.blade.php ENDPATH**/ ?>