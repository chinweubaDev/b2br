...
@section('title', 'Create Documentation Service - Admin Dashboard')
@section('page-title', 'Create Documentation Service')
...
<div class="glass-card p-6 mb-8">
    <div class="flex items-center justify-between flex-wrap gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-200">Create Documentation Service</h1>
            <p class="text-gray-400 mt-1">Add a new documentation service to the system</p>
        </div>
...
<div class="glass-card p-6">
    <form method="POST" action="{{ route('admin.documentation.store') }}" class="space-y-8">
        @csrf
