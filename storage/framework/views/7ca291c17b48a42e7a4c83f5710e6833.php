        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <?php if($tour->featured_image_url || $tour->image_url): ?>
                <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    <img src="<?php echo e(asset('public/storage' . $tour->featured_image ?? 'storage' . $tour->image)); ?>" alt="<?php echo e($tour->name); ?>" class="w-full h-96 object-cover">
                </div>
            <?php endif; ?>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        <?php $__currentLoopData = $tour->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="group relative overflow-hidden rounded-lg">
                                <img src="<?php echo e(asset('public/storage' . $image->image_url ?? 'storage' . $image->image_url )); ?>" 
                ...
                <div class="space-y-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900">+234 (0) 909 850 0918<br>
+234 (0) 912 101 4249</p>
                        </div>
                    </div>
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900">hi@royelimytravel.com</p>
                        </div>
                    </div>
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900">3rd floor, AIICO Towers, Churchgate St, Victoria Island, Lagos 106104, Lagos</p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u363422527/domains/royelimytravel.com/public_html/b2b/resources/views/tours/show.blade.php ENDPATH**/ ?>