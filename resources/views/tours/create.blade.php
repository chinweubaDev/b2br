                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                             <div>
                                    ...
                                    <select id="destination" name="destination" required class="w-full border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 @error('destination') border-red-500 @enderror">
