...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="<?php echo e(route('cruises.index')); ?>" class="btn-secondary">
        ...
        <div class="card">
            <form action="<?php echo e(route('cruises.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="Royal Caribbean" <?php echo e(old('cruise_line') == 'Royal Caribbean' ? 'selected' : ''); ?>>Royal Caribbean</option>
                                <option value="Costa Cruises" <?php echo e(old('cruise_line') == 'Costa Cruises' ? 'selected' : ''); ?>>Costa Cruises</option>
                                <option value="Norwegian Cruise Line" <?php echo e(old('cruise_line') == 'Norwegian Cruise Line' ? 'selected' : ''); ?>>Norwegian Cruise Line</option>
                                <option value="MSC Cruises" <?php echo e(old('cruise_line') == 'MSC Cruises' ? 'selected' : ''); ?>>MSC Cruises</option>
                                <option value="Celebrity Cruises" <?php echo e(old('cruise_line') == 'Celebrity Cruises' ? 'selected' : ''); ?>>Celebrity Cruises</option>
                                <option value="Princess Cruises" <?php echo e(old('cruise_line') == 'Princess Cruises' ? 'selected' : ''); ?>>Princess Cruises</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="ship_name" name="ship_name" value="<?php echo e(old('ship_name')); ?>" required class="form-input <?php $__errorArgs = ['ship_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="route" name="route" value="<?php echo e(old('route')); ?>" required class="form-input <?php $__errorArgs = ['route'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="date" id="departure_date" name="departure_date" value="<?php echo e(old('departure_date')); ?>" required class="form-input <?php $__errorArgs = ['departure_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" id="return_date" name="return_date" value="<?php echo e(old('return_date')); ?>" required class="form-input <?php $__errorArgs = ['return_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" id="duration_nights" name="duration_nights" value="<?php echo e(old('duration_nights')); ?>" min="1" required class="form-input <?php $__errorArgs = ['duration_nights'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('ports_of_call')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-end space-x-4 mt-8">
                    <a href="<?php echo e(route('cruises.index')); ?>" class="btn-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u363422527/domains/royelimytravel.com/public_html/b2b/resources/views/cruises/create.blade.php ENDPATH**/ ?>