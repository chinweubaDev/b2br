...
<div class="bank-transfer-wrapper">
    ...
    <nav class="breadcrumb-nav">
        ...
        <a href="{{ route('payment.history') }}">Payments</a>
        <i class="fas fa-chevron-right"></i>
    ...
    <div class="payment-summary">
        <div class="summary-row">
            ...
            <span class="summary-value">{{ ucfirst($payment->service_type) }} - {{ $payment->service_name }}</span>
        </div>
        <div class="summary-row">
            <span class="summary-label">Amount to Transfer</span>
            <span class="summary-value amount">{{ $payment->formatted_amount }}</span>
        </div>
    </div>
    ...
    <div class="bank-details-card">
        ...
        <div class="detail-item">
            ...
            <span class="detail-value">{{ $payment->getBankTransferDetails()['bank_name'] }}</span>
        </div>

        <div class="detail-item">
            <span class="detail-label">Account Name</span>
            <span class="detail-value">{{ $payment->getBankTransferDetails()['account_name'] }}</span>
        </div>

        <div class="detail-item">
            <span class="detail-label">Account Number</span>
            <span class="detail-value">{{ $payment->getBankTransferDetails()['account_number'] }}</span>
        </div>

        <div class="detail-item">
            <span class="detail-label">Sort Code</span>
            <span class="detail-value">{{ $payment->getBankTransferDetails()['sort_code'] }}</span>
        </div>

        <div class="detail-item">
            <span class="detail-label">Payment Reference</span>
            <span class="detail-value reference">{{ $payment->getBankTransferDetails()['reference'] }}</span>
        </div>
