            ...
            <div class="filters-grid">
                <div class="filter-group">
                    ...
                    <div class="filter-input-wrapper">
                        ...
                        <input type="text" id="search" class="filter-input" placeholder="Where do you want to go?" value="<?php echo e(request('search')); ?>">
                    </div>
                </div>
                <div class="filter-group">
            ...
            <div class="tour-card">
                <div class="tour-image">
                    ...
                    <?php if($tour->featured_image_url || $tour->image_url): ?>
                        <img src="<?php echo e($tour->featured_image ? asset('public/storage/' . $tour->featured_image) : asset('storage/' . $tour->image)); ?>" alt="<?php echo e($tour->name); ?>">
                    <?php else: ?>
                ...
                <div class="tour-content">
                    <div class="destination-tag">
                        <i class="fas fa-map-pin"></i> <?php echo e($tour->destination); ?>

                    </div>
                    
                    <h3 class="tour-title"><?php echo e($tour->name); ?></h3>
                    
                    <div class="tour-meta">
                        <span class="meta-item">
                            <i class="far fa-clock"></i> <?php echo e($tour->duration_days); ?> Days
                        </span>
                        <span class="meta-item">
                            <i class="far fa-compass"></i> <?php echo e(ucfirst($tour->category)); ?>
                    ...
                    <div class="tour-pricing">
                        <div class="price-group">
                            ...
                            <span class="old-price">₦<?php echo e(number_format($tour->standard_rate)); ?></span>
                        </div>
                        <div class="price-group" style="text-align: right;">
                            <span class="price-label">Your Rate</span>
                            <span class="price-value">₦<?php echo e(number_format($tour->b2b_rate)); ?></span>
                        </div>
                    </div>

                    <div class="tour-actions">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('payment.options', ['tour', $tour->id])); ?>" class="btn-book">
                                Book Now <i class="fas fa-arrow-right" style="margin-left: 8px;"></i>
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="btn-book">
                                Login to Book
                            </a>
                        <?php endif; ?>
                        <a href="<?php echo e(route('tours.show', $tour)); ?>" class="btn-details">
                            View Details
                        </a>
                    </div>
                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function applyFilters() {
            ...
            window.location.href = queryString ? `<?php echo e(route('tours.index')); ?>?${queryString}` : '<?php echo e(route('tours.index')); ?>';
        }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/simeonuba/b2br/resources/views/tours/index.blade.php ENDPATH**/ ?>