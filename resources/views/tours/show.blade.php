        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            @if($tour->featured_image_url || $tour->image_url)
                <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    <img src="{{ asset('public/storage' . $tour->featured_image ?? 'storage' . $tour->image) }}" alt="{{ $tour->name }}" class="w-full h-96 object-cover">
                </div>
            @endif
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        @foreach($tour->images as $image)
                            <div class="group relative overflow-hidden rounded-lg">
                                <img src="{{ asset('public/storage' . $image->image_url ?? 'storage' . $image->image_url ) }}" 
